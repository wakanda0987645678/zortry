        ...
        <div className="relative">
          ...
          <div className="px-3 pt-3 pb-3 sm:px-5 sm:pt-5 sm:pb-5">
            ...
            <div className="relative mb-2 sm:mb-3 flex items-start justify-between">
              ...
              {/* Badge */}
              <div className="bg-background/90 backdrop-blur-sm px-2 py-0.5 sm:px-3 sm:py-1 rounded-full flex items-center gap-1 sm:gap-1.5 border border-border/50">
                <CoinsIcon className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-primary" />
                <span className="text-[10px] sm:text-xs font-semibold text-foreground">Creator</span>
              </div>
            </div>
